...
public class SubscriptionService {
	...
	public SubscriptionDTO findByIdSubscription(UUID id) {
		...
		subDTO.setOperation(Operation.FIND_BY_ID);
		subDTO.setId(id);
	...
	public void delete(UUID id) {
		if (checkUnsubscribe(id)) {
			SubscriptionDTO subDTO = new SubscriptionDTO();
			subDTO.setId(id);
			subDTO.setOperation(Operation.DELETE);
	...
	public SubscriptionDTO createSubscription(Integer id, UUID userId) {
		...
		subDTO.setOperation(Operation.CREATE);
	...
	public List<SubscriptionDTO> findAll() {
		SubscriptionDTO subDTO = new SubscriptionDTO();
		subDTO.setOperation(Operation.FIND_ALL);
